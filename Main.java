...
public class Main {
    ...
    /**
     * Prints the menu, from which we may choose our 6 options, etc.
     *
     * @param args N/A
     */
     ...
     * Addition
     *
     * @param matrix1 is the first matrix we input
     */
     ...
     *
     * @param matrix is the matrix we input
     */
    ...
    /**
     * Transposes a matrix along the main diagonal
     *
     * @param matrix is the matrix being transposed
     */
    ...
    /**
     * Transposes a matrix horizontally
     *
     * @param matrix is the matrix being transposed
     */
    ...
    /**
     * Transposes a matrix vertically
     *
     * @param matrix is the matrix being transposed
     */
     ...
     *
     * @param matrix is the matrix we are finding the determinant of
     */
    ...
    /**
     * Finds the determinant of a matrix by using recursion
     *
     * @param matrix is the matrix being transposed
     */
    ...
    /**
     * Gives the submatrix of n-1 by n-1 size where n is the size of a square matrix. We can choose to omit
     * a certain column and row
     *
     * @param matrix the matrix we are getting a submatrix of
     * @param row the row to omit
     * @param col the column to omit
     * @param size the size of the the new submatrix (this will be n-1)
     ...
     *
     * @param matrix is the matrix we are printing the inverse of
     */
     ...
     *
     * @param matrix is the matrix we are finding the inverse of
     * @param oneOverDet is 1/the determinant of the matrix
    ...
    /**
     * Prints the menu of the 6 possible options and the exit option
     */
